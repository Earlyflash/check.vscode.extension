/**
 * GitHub repo trustworthiness evaluation.
 * Scores repo metadata against github-repo-safety-policy.json.
 * Same pattern as extension evaluation: higher score = higher risk.
 */

export function evaluateRepo(metadata, policy) {
  let score = 0;
  const triggered = [];
  ...
  // ---- Engagement: low stars/forks suggest little community adoption ----
  ...
  // ---- Freshness: very new repo or long since last push ----
