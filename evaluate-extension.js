/**
 * Extension safety evaluation engine.
 * No external dependencies. Use in CI, ingestion, or with Node:
 *   node evaluate-extension.js
 *   node -e "const {evaluateExtension}=require('./evaluate-extension');..."
 *
...
// Run as script: node evaluate-extension.js
